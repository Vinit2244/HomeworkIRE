...
3. [Features and Implementation](#3-features-and-implementation)
    * [3.1 System Architecture](#31-system-architecture)
    * [3.2 Configuration Components](#32-configuration-components)
    * [3.3 Query Processing](#33-query-processing)
    * [3.4 Query Set Generation](#34-query-set-generation)
...
├── generate_frequency_plots.py # Generates word frequency plots.
├── generate_queries.py       # Generates random queries for testing.
├── setup_queries.py          # Generates ground truth from ES for custom index comparison.
├── constants.py              # Project-wide constants.
├── utils.py                  # Utility functions.
│
├── dataset_managers/         # Modules for loading and managing different datasets.
│   ├── dataset_base.py
│   ├── dataset_news.py
...
│   └── preprocessor.py
│
└── indexes/                  # Core indexing and querying logic.
     ├── index_base.py         # Abstract base class for all index types.
     ├── index_es.py           # Elasticsearch index implementation.
     ├── index_custom.py       # Custom index (`CustomIndex`) implementation.
     ├── encoder.py            # Logic for data compression/encoding.
     │
     └── query_processing/     # Custom query engine.
